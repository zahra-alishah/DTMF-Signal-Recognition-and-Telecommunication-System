...
% Part 8-1-5: Recognize digits from DTMF signal
% Input:Demodulated_DTMF_8_1_4.wav (DTMF tones + silence)
...
test = DTMF_to_StudentID("Demodulated_DTMF_8_1_4.wav");
disp([test])

%% definition of function

function StudentID = DTMF_to_StudentID(audio_file)
    ...
    num_digits = floor(length(signal) / total_samples_per_digit);  
    if length(signal) > num_digits * total_samples_per_digit + 500
